...
import 'cppLessonCorrectAnswer.dart';

class CppLessonAnswerWidget extends StatefulWidget {
  final lessonName;
  final lessonChecked;
  const CppLessonAnswerWidget({Key? key, this.lessonName, this.lessonChecked})
      : super(key: key);

  @override
  _CppLessonAnswerWidgetState createState() => _CppLessonAnswerWidgetState();
}

class _CppLessonAnswerWidgetState extends State<CppLessonAnswerWidget> {
