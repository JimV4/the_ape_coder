...
class CppLessonWidget extends StatefulWidget {
  final String lessonName;
  final bool lessonChecked;
  CppLessonWidget(
      {Key? key, required this.lessonName, required this.lessonChecked})
      : super(key: key);

  @override
  _CppLessonWidgetState createState() => _CppLessonWidgetState();
}

class _CppLessonWidgetState extends State<CppLessonWidget> {
            ...
            child: ElevatedButton(
              onPressed: () => {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => CppLessonAnswerWidget(
