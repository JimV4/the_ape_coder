...
class JavascriptLessonAnswerWidget extends StatefulWidget {
  final lessonName;
  final lessonChecked;
  const JavascriptLessonAnswerWidget(
      {Key? key, this.lessonName, this.lessonChecked})
      : super(key: key);

  @override
  _JavascriptLessonAnswerWidgetState createState() =>
      _JavascriptLessonAnswerWidgetState();
}

class _JavascriptLessonAnswerWidgetState
    extends State<JavascriptLessonAnswerWidget> {
                          ...
                          onPressed: () {
                            ...
                            if (userPost == '42') {
                              ...
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (context) =>
                                      JavascriptLessonCorrectAnswerWidget(
