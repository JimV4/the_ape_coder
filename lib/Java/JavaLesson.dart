...
import 'package:ape_coder/Java/JavaLessonAnswer.dart';
import 'package:ape_coder/Java/JavaLessons.dart';

class JavaLessonWidget extends StatefulWidget {
  final String lessonName;
  final lessonChecked;
  JavaLessonWidget({Key? key, required this.lessonName, this.lessonChecked})
      : super(key: key);

  @override
  _JavaLessonWidgetState createState() => _JavaLessonWidgetState();
}

class _JavaLessonWidgetState extends State<JavaLessonWidget> {
            ...
            child: ElevatedButton(
              onPressed: () => {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => JavaLessonAnswerWidget(
              ...
              style: ButtonStyle(
                ...
                shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                  RoundedRectangleBorder(
                    ...
                    side: BorderSide(color: Color.fromARGB(255, 215, 83, 215)),
                  ),
                ),
              ),
            ),
